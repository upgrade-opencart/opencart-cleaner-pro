	...
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'report/statistics')) {
				...
				if ($this->user->hasPermission('access', 'extension/module/cleaner_pro')) {
					$cleaner_pro[] = array(
						'name'	   => $this->language->get('text_clean_junk'),
				...
				if ($cleaner_pro) {
					$data['menus'][] = array(
						'id'       => 'menu-cleaner-pro',
						'icon'	   => 'fa-rocket',
						'name'	   => $this->language->get('text_cleaner_pro'),
						'href'     => '',
						'children' => $cleaner_pro
					);
				}
